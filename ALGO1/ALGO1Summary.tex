...
\begin{itemize}[noitemsep]
	...
	Algorithme de Kruskal (TODO à détailler)
	
	Algorithme de Prim (TODO à détailler)
\end{itemize}
%
...
\begin{itemize}[noitemsep]
	...
	\begin{itemize}[noitemsep]
		...
		\( d_{i,j,k} = \) distance minimale allant de i à j %
		passant par les k premiers sommets 
		\item Algorithme de Bellman-Ford (TODO à détailler)
	\end{itemize}
